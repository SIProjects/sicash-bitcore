...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x000000000000000000000000000000000000000000000036a70ae675b98824c5"); // sicash
        ...
        vSeeds.push_back(CDNSSeedData("sicash3.dynu.net", "sicash3.dynu.net", false)); // SICash mainnet
...
public:
    CTestNetParams() {
        ...
        // The best chain should have at least this much work.
        consensus.nMinimumChainWork = uint256S("0x00000000000000000000000000000000000000000000000d6e528bcf5a3a556f"); // sicash
        ...
        vSeeds.push_back(CDNSSeedData("sicash4.dynu.net", "sicash4.dynu.net", false)); // SICash testnet

        vSeeds.push_back(CDNSSeedData("sicash-testnet1.earlz.net", "sicash-testnet1.earlz.net", false)); // SICash testnet
...
public:
    CRegTestParams() {
        ...
        consensus.BIP34Height = 0; // BIP34 has not activated on regtest (far in the future so block v1 are not rejected in tests) // activate for sicash
