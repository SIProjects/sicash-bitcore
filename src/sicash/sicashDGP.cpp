...
bool SICashDGP::checkLimitSchedule(const std::vector<uint32_t>& defaultData, const std::vector<uint32_t>& checkData){
...
dev::eth::EVMSchedule SICashDGP::getGasSchedule(unsigned int blockHeight){
    clear();
...
dev::eth::EVMSchedule SICashDGP::createEVMSchedule(){
    dev::eth::EVMSchedule schedule = dev::eth::EIP158Schedule;
