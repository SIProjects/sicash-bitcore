...
bool BlockAssembler::AttemptToAddContractToBlock(CTxMemPool::txiter iter, uint64_t minGasPrice) {
    ...
    SICashTxConverter convert(iter->GetTx(), NULL, &pblock->vtx);
    ...
    ByteCodeExec exec(*pblock, sicashTransactions, hardBlockGasLimit);
...
void StakeSICashs(bool fStake, CWallet *pwallet)
{
