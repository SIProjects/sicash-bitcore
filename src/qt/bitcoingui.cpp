...
#include "titlebar.h"
#include "sicashversionchecker.h"
    ...
    platformStyle(_platformStyle)
{
    ...
    if(fCheckForUpdates && sicashVersionChecker->newVersionAvailable())
    {
...
void BitcoinGUI::createActions()
{
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible SICash command-line options").arg(tr(PACKAGE_NAME)));
...
{
    QString strTitle = tr("SICash"); // default title
