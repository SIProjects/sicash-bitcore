...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("sicash://", Qt::CaseInsensitive))
    {
        uri.replace(0, 7, "sicash:"); // SICASH: change string length to 7 to correctly parse sicash://
    }
...
{
    QString ret = QString("sicash:%1").arg(info.address);
    int paramCount = 0;
...
boost::filesystem::path static GetAutostartFilePath()
{
    ...
    return GetAutostartDir() / strprintf("sicash-%s.lnk", chain);
}
